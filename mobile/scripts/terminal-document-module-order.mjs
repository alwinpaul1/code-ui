...
export const TERMINAL_DOCUMENT_MODULE_ORDER = [
  ...
  'cell-geometry',
  // Code UI: the scrollback's ends bend instead of stopping dead (9a6507b6). Upstream has no such
  // module; it sits where the fork's hand-written document carried the slice.
  'overscroll-bend',
  'path-tap',
  'url-tap',
  'osc-link-tap',
