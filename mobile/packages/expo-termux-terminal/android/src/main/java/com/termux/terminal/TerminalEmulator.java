...
public final class TerminalEmulator {
    ...
    // CODE UI: the host mirrors the program's modes to the app's gesture and paste gates, which
    // xterm and libghostty report the same way. The DECSET bits are private above.
    public boolean isBracketedPasteModeActive() {
        return isDecsetInternalBitSet(DECSET_BIT_BRACKETED_PASTE_MODE);
    }

    public boolean isMouseButtonEventTrackingActive() {
        return isDecsetInternalBitSet(DECSET_BIT_MOUSE_TRACKING_BUTTON_EVENT);
    }

    public boolean isSgrMouseProtocolActive() {
