    ...
    public void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                // CODE UI: no "Paste": it wrote the clipboard straight to the PTY through the session, a
                // path this host reserves for the emulator's own bytes; the app's accessory row pastes.
                // CODE UI: no "More": it opened the view's context menu, and this host registers none.
                return true;
            }
