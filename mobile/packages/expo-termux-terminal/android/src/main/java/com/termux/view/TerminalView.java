...
/** View displaying and interacting with a {@link TerminalViewSession}. */
// CODE UI: not final, so the host can refuse focus (HostedTerminalView) without editing the tap path.
public class TerminalView extends View {
    ...
    public TerminalViewSession mTermSession;
    ...
    /**
     * Attach a {@link TerminalViewSession} to this view.
     *
     * @param session The {@link TerminalViewSession} this view will be displaying.
     */
    public boolean attachSession(TerminalViewSession session) {
    ...
    public TerminalViewSession getCurrentSession() {
        return mTermSession;
    }
     ...
     * {@link TerminalViewClient#onEmulatorSet()} event after calling {@link #attachSession(TerminalViewSession)}
     ...
     * call this directly after {@link #attachSession(TerminalViewSession)} since {@link #updateSize()}
     ...
     * before calling this.
     *
     * It should also be called after terminal is reset with the session's reset in case
