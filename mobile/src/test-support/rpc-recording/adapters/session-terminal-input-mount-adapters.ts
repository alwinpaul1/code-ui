 ...
 *
 * CODE UI: upstream's copy also resets the worker-takeover report window each mount; this fork
 * has no orchestration workers and none of these sends reports one.
 */
