 ...
 * this fork's own measurement (264 goldens, 13 identical, no `write-ordinal` class because the
 * recorder here has no subscription lane yet) is the pin in `BRIDGED_PARITY_BASELINE`.
 *
