...
export const C2_TASK_SOURCE_CLOSURE_FAMILIES: PageClosurePins = {
  // CODE UI (2026-09-19, Orca #21712 port): this fork's families, pinned from a measured bridged
  // run over its 759-golden corpus; the same 22 families upstream lists here.
