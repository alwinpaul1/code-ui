...
describe('the C3 page closure', () => {
   ...
   */
  // CODE UI (2026-09-21): upstream's 28 / 125 are this fork's 26 / 116 plus the two C1 families
  // whose recorder scenarios this fork does not carry (the C1 pin names them); the explorer's one
  // family and the preview's five are the same six here. Re-pinned from a measured run, as the
  // C1, C2 and C5 pins were.
  it('is the census the design named: 26 families, 116 goldens on this fork', () => {
