...
export type ThemeColors = {
  ...
  bgDock: string
  /** The composer box on that dock: a touch more solid, still see-through. */
  bgPanelGlass: string
  border: string
  borderStrong: string
  text: string
   ...
   *  (reported 2026-09-12). */
  codeSpanBg: string
  /** Inline `code` chip: text, fill and hairline border, after the Claude app. */
  codeSpanText: string
  codeSpanBorder: string
  diffAddBg: string
  diffAddText: string
  diffDelBg: string
  diffDelText: string
...
export const lightColors: ThemeColors = {
  ...
  bgDock: 'rgba(243, 241, 234, 0.78)',
  bgPanelGlass: 'rgba(251, 250, 246, 0.82)',
  border: '#E1DDD2',
  borderStrong: '#CCC7BB',
  text: '#1E1C19',
  ...
  codeBg: '#ECE9E0',
  codeSpanBg: 'rgba(37, 99, 235, 0.08)',
  codeSpanText: '#1D4ED8',
  codeSpanBorder: 'rgba(37, 99, 235, 0.22)',
...
export const darkColors: ThemeColors = {
  ...
  bgDock: 'rgba(26, 25, 23, 0.78)',
  bgPanelGlass: 'rgba(33, 31, 28, 0.82)',
  border: '#332F2A',
  borderStrong: '#45403A',
  text: '#ECE9E2',
  ...
  codeSpanText: '#8AB4F8',
  codeSpanBorder: 'rgba(138, 180, 248, 0.28)',
