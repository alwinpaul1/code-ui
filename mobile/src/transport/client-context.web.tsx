...
function createPlaceholderClient(): RpcClient {
  return {
    ...
    // Code UI: no `getGeneration` — this fork's RpcClient has not taken Orca #20914's optional
    // generation counter yet; the placeholder answers the port this fork declares.
    onStateChange: () => () => {},
    notifyForeground: () => {},
    close: () => {}
  }
