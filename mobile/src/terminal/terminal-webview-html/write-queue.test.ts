...
// Code UI note: the harness below also declares the scroll-gesture write-hold vars, which this
// fork's queue carries and upstream's does not. The hold is inactive here, so the queue drains
// exactly as upstream's harness drives it.
