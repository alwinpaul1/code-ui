...
describe('diagnoseConnection on the other relay close codes', () => {
  ...
  // Fork copy: upstream's line blames the phone's connection outright, but a 1006 is equally
  // the Relay being down, and this fork's line (connection-diagnostics-analysis.test.ts, the
  // bare relay_outer_1006 case) tells the user how to tell the two apart first.
  it('names both readings of a transport close, and keeps it unreportable', () => {
