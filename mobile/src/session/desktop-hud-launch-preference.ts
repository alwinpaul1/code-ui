...
/** Default on: a fresh install should show the HUD for desktop-started
 *  agents too. The switch lives in Settings → Chat UI and turning it off
 *  removes the flags from the host's launch profile again. */
