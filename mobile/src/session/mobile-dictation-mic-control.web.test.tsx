...
vi.mock('lucide-react-native', () => ({
  Image: (props: Record<string, unknown>) => createElement('lucide-image', props),
  ...
  Plus: (props: Record<string, unknown>) => createElement('lucide-plus', props)
}))
// CODE UI: this fork's control is themed and opens an attach sheet and a level meter; none of the
// three is what this observes, and the real ones reach the platform this renderer does not have.
// The colours are read by name, so any string answers.
