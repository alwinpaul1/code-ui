 ...
 * plus the status-line flags that make the agent paint its model, effort,
 * context and limits for the HUD. Null when there is nothing to add, so the
 * host launches exactly as it always did.
 */
