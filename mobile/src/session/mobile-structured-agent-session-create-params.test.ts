// Upstream ships this as src/shared/structured-agent-session-create.test.ts. It
// lives here instead because this fork's vitest root is mobile/, so a test under
// src/shared is vendored but never collected — and mobile-structured-agent-
// session-launch.ts calls these params on every structured chat it opens.
