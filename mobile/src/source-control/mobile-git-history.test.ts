...
describe('formatCommitTime', () => {
  ...
  it('treats desktop epoch-millisecond timestamps as milliseconds (#17729)', () => {
    expect(formatCommitTime(NOW - 3 * 3600 * 1000, NOW)).toBe('3h')
    expect(formatCommitTime(NOW - 40 * 86400 * 1000, NOW)).toBe('1mo')
