...
// CODE UI HAND-APPLIED UPSTREAM HUNK (Orca #18765, 172aa1ac3): the edit-patch
// shapes and the `editPatch` field. The file cannot be re-vendored whole at
// that commit because it also carries the forward-ported `presentation`/`tone`
// hints from #19228. See src/shared/LOCAL-FILES.md.
