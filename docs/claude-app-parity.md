...
| 10 | Screenshot markup: draw on a screenshot with a pen, undo and redo, "Discard markup?" on close, attach it with an edit pencil | Not present | merged (cb571619). No pencil over the composer photo: a tap on it opens markup, the user's call (2026-09-24). Drawing feel and the flattened image need a phone check |
